...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"4fdee479-a8bc-48b1-86b2-a83850428149\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [23 x i8] c"com.companyname.bstugo\00", align 16
...
@__DSOCacheEntry_name.5 = internal constant [19 x i8] c"libyandexmapkit.so\00", align 16
...
@dso_cache = local_unnamed_addr global [32 x %struct.DSOCacheEntry] [
	...
	; 4
	%struct.DSOCacheEntry {
		i64 3345754693209922048, ; hash 0x2e6e822aba5f9a00, from name: libyandexmapkit
		i8 0, ; ignore
	...
	; 6
	%struct.DSOCacheEntry {
		i64 3645210240414067811, ; hash 0x32966366877f2c63, from name: libyandexmapkit.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 28
	%struct.DSOCacheEntry {
		i64 17523568154568554619, ; hash 0xf33038648a67f87b, from name: yandexmapkit
		i8 0, ; ignore
		i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 29
	%struct.DSOCacheEntry {
		i64 17588774765718266490, ; hash 0xf417e175c8fde27a, from name: yandexmapkit.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
