...
@dso_cache = local_unnamed_addr global [32 x %struct.DSOCacheEntry] [
	...
	; 4
	%struct.DSOCacheEntry {
		i64 525862808, ; hash 0x1f580798, from name: yandexmapkit
		i8 0, ; ignore
	...
	; 7
	%struct.DSOCacheEntry {
		i64 781864409, ; hash 0x2e9a4dd9, from name: libyandexmapkit
		i8 0, ; ignore
		i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 14
	%struct.DSOCacheEntry {
		i64 2119930046, ; hash 0x7e5b90be, from name: libyandexmapkit.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 15
	%struct.DSOCacheEntry {
		i64 2214834180, ; hash 0x8403b004, from name: yandexmapkit.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
